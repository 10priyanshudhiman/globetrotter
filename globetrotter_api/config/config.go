...
func LoadConfig() {
	...
	C.Redis.Host = getEnv("REDIS_HOST", "tramway.proxy.rlwy.net")
	C.Redis.Port = getEnv("REDIS_PORT", "22763")
	C.Redis.Password = getEnv("REDIS_PASSWORD", "OynFGNfGtaSaoPFsebRuQOQXdqpaLQTE")
